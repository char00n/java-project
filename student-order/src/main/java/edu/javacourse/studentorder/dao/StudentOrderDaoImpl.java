...
public class StudentOrderDaoImpl implements StudentOrderDao {
    ...
    private static final  String INSERT_ORDER =
            "INSERT INTO jc_student_order(" +
                    ...
                    "certificate_id, register_office_id, marrige_date)" +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";

    private static final String INSERT_CHILD =
            "INSERT INTO jc_student_child(" +
                    "student_order_id, c_sur_name, c_given_name, c_patronymic, c_date_of_birth, c_certificate_number, c_certificate_date, c_register_office_id, c_post_index, c_street_code, c_building, c_extension, w_apartment)" +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    private void fillMarriage(ResultSet rs, StudentOrder so) throws SQLException {
        ...
        so.setMarriageDate(rs.getDate("marrige_date").toLocalDate());
    ...
    private Child fillChild(ResultSet rs) throws SQLException {
        ...
        adr.setApartment(rs.getString("w_apartment"));
